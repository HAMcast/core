...
class multicast_socket
{
 ...
 public:
    ...
    // make multicast_socket noncopyable c++ 11 style
    multicast_socket(const multicast_socket&) = delete;
    multicast_socket& operator = (const multicast_socket&) = delete;
     ...
     */
    bool try_receive(multicast_packet& storage, std::uint16_t milliseconds);
     ...
     */
    void set_ttl(std::uint32_t value);
    ...
    static void release_storage(d_ptr& sock_private, std::int32_t bytes);
