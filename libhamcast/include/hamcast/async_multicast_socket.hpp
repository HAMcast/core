...
class async_multicast_socket
{
 ...
 public:
    ...
    // make async_multicast_socket noncopyable c++ 11 style
    async_multicast_socket(const async_multicast_socket&) = delete;
    async_multicast_socket& operator = (const async_multicast_socket&) = delete;
