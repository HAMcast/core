 ...
 * @ingroup Config
 */
const std::uint32_t magic_number HC_STATIC_CONSTANT = 0xDEADC0DE;

/**
 * @brief The major version of the library.
 * @ingroup Config
 */
const std::uint32_t major_version HC_STATIC_CONSTANT = 0;

/**
 * @brief The minor version of the library.
 * @ingroup Config
 */
const std::uint32_t minor_version HC_STATIC_CONSTANT = 6;

/**
 * @brief The minimum major version that is (IPC) compatible to this version.
 * @ingroup Config
 */
const std::uint32_t min_compatile_major_version HC_STATIC_CONSTANT = 0;

/**
 * @brief The minimum minor version that is (IPC) compatible to this version.
 * @ingroup Config
 */
const std::uint32_t min_compatile_minor_version HC_STATIC_CONSTANT = 6;
 ...
 */
const uint32_t default_max_msg_size HC_STATIC_CONSTANT = 8 * 1024;
