...
class sync_function_base
{
 ...
 public:
    ...
    typedef typename
            util::if_else_t<std::is_fundamental<T1>, T1, const T1&>::type
            arg1_t;

    typedef typename
            util::if_else_t<std::is_fundamental<T2>, T2, const T2&>::type
            arg2_t;

    typedef typename
            util::if_else_t<std::is_fundamental<T3>, T3, const T3&>::type
            arg3_t;

    typedef typename
            util::if_else_t<std::is_fundamental<T4>, T4, const T4&>::type
            arg4_t;

    typedef std::function<void(result_t&)> fun0_t;

    typedef std::function<void(result_t&,arg1_t)> fun1_t;

    typedef std::function<void(result_t&,arg1_t,arg2_t)> fun2_t;

    typedef std::function<void(result_t&,arg1_t,arg2_t,arg3_t)> fun3_t;

    typedef std::function<void(result_t&,arg1_t,arg2_t,arg3_t,arg4_t)> fun4_t;
 ...
 protected:
     ...
     */
    void reply(std::uint32_t req_id,
               const void* msg_content,
               std::uint32_t msg_content_size,
