...
inline bool atomic_cas(volatile std::int32_t* ptr,
 ...
 */
inline std::int32_t add_and_fetch(volatile std::int32_t* ptr,
                                    std::int32_t value);

inline std::uint32_t add_and_fetch(volatile std::uint32_t *ptr,
                                     std::uint32_t value)
{
    return static_cast<std::int32_t>(
                add_and_fetch(
                    reinterpret_cast<volatile std::int32_t*>(ptr),
...
inline int32_t add_and_fetch(volatile std::int32_t* ptr,
                                    std::int32_t value)
{
