...
struct mock_mutex
{
    ...
    inline bool timed_lock_shared(const std::chrono::system_clock::time_point&) { return true; }
    inline void unlock_shared() { }
    inline bool timed_lock(const std::chrono::system_clock::time_point&) { return true;}
